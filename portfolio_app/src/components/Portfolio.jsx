...
//                   <a href="https://justincanavanmusic.github.io/music-dashboard/">Demo</a>
                 
//                 </button>
//                 <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105">
//                   <a href="https://github.com/justincanavanmusic/music-dashboard">Code</a>
                  
//                 </button>
//               </div>
//               <div className="flex items-center justify-center">
//                 <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105">
//                   <a href="https://awele1111.github.io/Note-taker/">Demo</a>
                 
//                 </button>
//                 <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105">
//                   <a href="https://github.com/Awele1111/Note-taker">Code</a>
                  
//                 </button>
//               </div>
//               <div className="flex items-center justify-center">
//                 <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105">
//                   <a href="https://awele1111.github.io/Code-quiz/">Demo</a>
                 
//                 </button>
//                 <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105">
//                   <a href="https://github.com/Awele1111/Code-quiz">Code</a>
                  
//                 </button>
//               </div>
//               <div className="flex items-center justify-center">
//                 <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105">
//                   <a href="https://awele1111.github.io/challenge-1-real/">Demo</a>
                 
//                 </button>
//                 <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105">
//                   <a href="https://github.com/Awele1111/challenge-1-real">Code</a>
                  
//                 </button>
//               </div>
//               <div className="flex items-center justify-center">
//                 <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105">
//                   <a href="https://awele1111.github.io/Password-generator/">Demo</a>
                 
//                 </button>
//                 <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105">
//                   <a href="https://github.com/Awele1111/Password-generator">Code</a>
                  
//                 </button>
//               </div>
//               <div className="flex items-center justify-center">
//                 <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105">
//                   <a href="https://awele1111.github.io/portfolio/">Demo</a>
                 
//                 </button>
//                 <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105">
//                   <a href="https://github.com/Awele1111/portfolio">Code</a>
